...
const MainLayout = () => {
    ...
    if (user?.role === 'ADMIN') {
        menuItems.push({ key: '/users', icon: <UserOutlined />, label: 'Quản lý User' });
    }
        ...
        <Layout style={{ minHeight: '100vh' }}>
            ...
            <Layout>
                <Header style={{ padding: '0 16px', background: colorBgContainer, display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                    <Title level={4} style={{ margin: 0 }}>Hệ thống quản lý Texas Chicken</Title>
                ...
                <Content style={{ margin: '24px 16px', padding: 24, background: colorBgContainer, borderRadius: borderRadiusLG, minHeight: 280, overflow: 'initial' }}>
